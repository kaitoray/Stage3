...
Network level: Record a fault, then after 2000 packets, MU1 modifies and replayed malicious SV packets (all with values*1.5) to fake emergency situation on 66kV (2 scenarios) following the KCL/KVL laws.
